...
# ---------------------------------------------------------------- категории
CATEGORY_RULES = [
    ("bus", "Шины и проводники", (r"^line ", r"^\bn\b$", r"^pen$", r"^pe line$", r"^point$", r"^line$", r"^ugo$", r"провод")),
    ("breaker", "Автоматические выключатели (QF)", (r"^qf",)),
    ("rcd", "УЗО (QD)", (r"^qd",)),
    ("rcbo", "Дифавтоматы (QFD)", (r"^qfd",)),
    ("switch", "Рубильники и разъединители (QS)", (r"^qs",)),
    ("meter", "Приборы учёта", (r"^pi", r"счёт", r"счет", r"meter")),
    ("contactor", "Контакторы и реле", (r"^km", r"^kv", r"^k\b", r"реле", r"контактор")),
    ("spd", "Ограничители перенапряжения", (r"^fv", r"опн", r"spd")),
